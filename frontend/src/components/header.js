        ...
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav>
                    ...
                    <Nav.Link><Link to="/addCat" style={{ textDecoration: 'none' , color:'#c9c9c9'}}>Categories</Link></Nav.Link>
                    <Nav.Link><Link to="/profile" style={{ textDecoration: 'none' , color:'#c9c9c9'}}>Profile</Link></Nav.Link>
